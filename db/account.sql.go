...
SELECT id, owner, balance, currency, created_at, last_modified_at FROM account WHERE id = $1 LIMIT 1
`
...
SELECT id, owner, balance, currency, created_at, last_modified_at FROM account WHERE id = $1 LIMIT 1 FOR NO KEY UPDATE
`
